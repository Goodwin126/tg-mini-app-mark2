...
<template>
  <div class="flex flex-col">
    <div class="flex grid grid-cols-3">
      ...
      <router-link to="/water" class="m-auto mr-8">
        <img
          src="/Button.png"
          alt="Button_1"
      ...
      <router-link to="/eating" class="m-auto mr-8">
        <img
          src="/Button.png"
          alt="Button_2"
      ...
      <img
        ...
        class="m-auto hover:cursor-pointer mr-8"
      />
  ...
  <div class="flex grid grid-cols-4 mt-2 touch-none select-none">
    ...
    >
      ...
      <p class="m-auto text-sm font-italic text-black">Награды</p>
    </div>
    <div
      class="m-auto flex flex-col"
